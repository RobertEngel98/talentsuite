      ...
      <div style={{ background: "#f0f4f7", padding: mob ? "32px 16px 48px" : "56px 24px 72px" }}>
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: mob ? "1fr 1fr" : "1fr 1fr 1fr 1fr", gap: 12, marginBottom: 32 }}>
            {[
              { n: "18.000+", label: "Offene Stellen", color: "#1B98E0" },
              { n: "135 Tage", label: "Ø Vakanzzeit", color: "#EF4444" },
              { n: "13-19 €", label: "Kosten/Bewerbung", color: "#10B981" },
              { n: "Ø 26 Tage", label: "Bis zur Einstellung", color: "#1B98E0" },
            ].map((s, idx) => (
          ...
          <div style={{ background: "#ffffff", borderRadius: 16, padding: mob ? "24px 18px" : "32px 28px", marginBottom: 24, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            ...
            <p style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.7, margin: "0 0 16px" }}>
              Das Malerhandwerk kämpft mit sinkendem Nachwuchs und steigender Nachfrage. Die EU-Sanierungspflicht wird den Bedarf an Fachkräften weiter in die Höhe treiben.
            </p>
            <div style={{ padding: "14px 16px", background: "rgba(239,68,68,0.05)", border: "1px solid rgba(239,68,68,0.15)", borderRadius: 10, marginBottom: 10 }}>
              <p style={{ color: "#334155", fontSize: 15, lineHeight: 1.6, margin: 0 }}><strong>🔴</strong> Sanierungspflicht: Die EU-Gebäudeeffizienzrichtlinie treibt die Nachfrage nach Malern und Lackierern massiv nach oben.</p>
            </div>
          ...
          <div style={{ background: "rgba(239,68,68,0.05)", border: "1px solid rgba(239,68,68,0.15)", borderRadius: 16, padding: mob ? "24px 18px" : "32px 28px", marginBottom: 24 }}>
            ...
            <p style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.7, margin: 0 }}>
              Maler und Lackierer sind handwerklich orientiert — sie suchen nicht aktiv auf Jobbörsen, sind aber täglich auf Social Media unterwegs.
            </p>
          </div>
          ...
          <div style={{ background: "#ffffff", borderRadius: 16, padding: mob ? "20px 18px" : "28px 28px", marginBottom: 24, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            <h2 style={{ color: "#023B5B", fontSize: mob ? 18 : 22, fontWeight: 700, margin: "0 0 12px" }}>
              So gewinnen erfolgreiche Malerbetriebe heute Fachkräfte
            </h2>
            <p style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.7, margin: "0 0 12px" }}>Der Fachkräftemangel im Malerhandwerk ist keine vorübergehende Erscheinung — er ist strukturell und wird durch die Sanierungspflicht weiter verschärft.</p>
            ...
            <p style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.7, margin: 0 }}>Die Ergebnisse sprechen für sich: 13-19 € pro qualifizierte Bewerbung, 12-16% Conversion-Rate und durchschnittlich 26 Tage bis zur Einstellung.</p>
          </div>
