...
export default function Page() {
  ...
  const submit = async () => {
    ...
    trackLead({ formName: "mitarbeiter-finden-bau", category: "branchen-landing", industry: "Bau & Baugewerbe", value: 50 });
  };
        ...
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div className="bp-cta" data-track-section="cta-form" data-track-section-name="Kontaktformular" style={{ background: "linear-gradient(135deg, #091622, #0d1f30)", borderRadius: 16, padding: mob ? "32px 18px" : "44px 32px", textAlign: "center" }}>
            ...
            {!showForm && !sent ? (
              ...
              <div data-track-form="mitarbeiter-finden-bau" style={{ maxWidth: 440, margin: "0 auto", textAlign: "left" }}>
                {[
