...
export default function KfzCaseStudy() {
  ...
  const timeline = [
    { tag: "Woche 1", title: "Analyse & Setup", desc: "Zielgruppenanalyse im Umkreis von 50km, Kampagnenstruktur erstellt, KFZ-spezifischer Bewerberfunnel aufgebaut." },
    { tag: "Woche 2", title: "Erste Bewerbungen", desc: "14 Bewerbungen eingegangen. 7 davon qualifiziert. Erste Vorstellungsgespräche mit KFZ-Mechatronikern geführt." },
    { tag: "Woche 3", title: "Optimierung & Skalierung", desc: "Anzeigen optimiert, CPA von 28€ auf 18€ gesenkt. 15 weitere Bewerbungen." },
    { tag: "Woche 4-5", title: "Einstellungen", desc: "42 Bewerbungen gesamt. 6 KFZ-Fachkräfte eingestellt. Zeitarbeit um 85% reduziert." },
  ];
    ...
    <div id="pf" style={{ background: "#f0f4f7", minHeight: "100vh" }}>
      ...
      <div style={{ background: `linear-gradient(135deg, ${DARK} 0%, ${BRAND} 50%, #0A4D72 100%)`, padding: mob ? "48px 16px 56px" : "72px 24px 80px", textAlign: "center" }}>
        ...
        <div style={{ display: "inline-block", padding: "5px 18px", borderRadius: 20, marginBottom: 16, background: "rgba(16,185,129,0.15)" }}>
          <span data-pf="green" style={{ fontSize: 11, fontWeight: 700, letterSpacing: 3, color: GREEN }}>CASE STUDY · KFZ</span>
        </div>
        <h1 data-pf="white" style={{ color: "#ffffff", fontSize: mob ? 26 : 38, fontWeight: 800, margin: "0 0 14px", lineHeight: 1.15, maxWidth: 700, marginLeft: "auto", marginRight: "auto" }}>
          6 KFZ-Mechatroniker in <span data-pf="accent" style={{ color: ACCENT }}>5 Wochen</span> – ohne Jobportale
        </h1>
        <p data-pf="white70" style={{ color: "rgba(255,255,255,0.7)", fontSize: mob ? 15 : 18, maxWidth: 520, margin: "0 auto" }}>
          Wie Autohaus Müller in NRW den Fachkräftemangel mit Social Media Recruiting gelöst hat.
        </p>
      </div>
      ...
      <div style={{ ...containerStyle, paddingTop: mob ? 24 : 40, paddingBottom: mob ? 48 : 64 }}>
        ...
        <div className="pf-2" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 10, marginBottom: 24, marginTop: mob ? -28 : -36 }}>
          {[
            { n: "42", l: "Bewerbungen" },
            { n: "18", l: "Qualifiziert" },
            { n: "6", l: "Einstellungen", highlight: true },
            { n: "195€", l: "pro Einstellung" },
          ].map((s, i) => (
        ...
        <div style={{ background: "#ffffff", borderRadius: 16, padding: mob ? "24px 18px" : "28px 24px", boxShadow: "0 4px 20px rgba(0,0,0,0.06)", marginBottom: 20 }}>
          ...
          <p data-pf="darkbody" style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.7, margin: "0 0 12px" }}>
            Autohaus Müller – ein mittelständisches Autohaus mit Werkstatt und 45 Mitarbeitern in NRW – suchte dringend KFZ-Fachkräfte. Die Situation:
          </p>
          <ul style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.8, margin: 0, paddingLeft: 20 }}>
            <li data-pf="darkbody">6 offene Stellen für KFZ-Mechatroniker und einen Meister seit über 8 Monaten</li>
            <li data-pf="darkbody">0 qualifizierte Bewerbungen über Indeed und Arbeitsagentur</li>
            <li data-pf="darkbody">Zeitarbeit kostete über 280.000€ pro Jahr</li>
            <li data-pf="darkbody">Werkstattauslastung nur noch bei 65% – Aufträge wurden abgelehnt</li>
            <li data-pf="darkbody">Gute Leute wanderten in die besser zahlende Industrie ab</li>
          </ul>
        </div>
        ...
        <div style={{ background: "#ffffff", borderRadius: 16, padding: mob ? "24px 18px" : "28px 24px", boxShadow: "0 4px 20px rgba(0,0,0,0.06)", marginBottom: 20 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            {[
              { icon: "🎯", title: "Zielgruppe definiert", desc: "KFZ-Mechatroniker und Meister im Umkreis von 50km, die nicht aktiv suchen aber offen für eine bessere Werkstatt sind." },
              { icon: "📱", title: "Social Media Kampagnen", desc: "Gezielte Anzeigen auf Facebook und Instagram mit authentischen Einblicken in die Werkstatt und das Team." },
          ...
          <div style={{ marginTop: 16, padding: "12px 16px", borderRadius: 10, background: `${ACCENT}10`, borderLeft: `3px solid ${ACCENT}` }}>
            <p style={{ color: BRAND, fontSize: 14, fontWeight: 600, margin: 0 }}>
              Monatliches Budget: 2.800€ – ein Bruchteil der Zeitarbeitskosten
            </p>
          </div>
        </div>
        ...
        <div style={{ background: "#ffffff", borderRadius: 16, padding: mob ? "24px 18px" : "28px 24px", boxShadow: "0 4px 20px rgba(0,0,0,0.06)", marginBottom: 20 }}>
          ...
          <div className="pf-2" style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
            {[
              ...
              { label: "Einstellungen", value: "6", sub: "KFZ-Fachkräfte" },
              { label: "Kosten/Einstellung", value: "195€", sub: "statt 5.000€+" },
              { label: "Zeitraum", value: "5 Wochen", sub: "statt 8+ Monate" },
              { label: "Kostenreduktion", value: "85%", sub: "vs. Zeitarbeit" },
            ].map((r, i) => (
        ...
        <div style={{ background: "#ffffff", borderRadius: 16, padding: mob ? "24px 18px" : "32px 24px", boxShadow: "0 4px 20px rgba(0,0,0,0.06)", marginBottom: 24, borderLeft: `4px solid ${ACCENT}` }}>
          <p style={{ color: BRAND, fontSize: mob ? 16 : 18, fontStyle: "italic", lineHeight: 1.7, margin: "0 0 12px" }}>
            „Wir waren skeptisch – nach 8 Monaten ohne Bewerbungen über die Arbeitsagentur. Aber nach nur 3 Wochen mit TalentSuite hatten wir mehr Vorstellungsgespräche als im gesamten letzten Jahr. Die Qualität der Bewerber war herausragend. Wir konnten alle Stellen besetzen und unsere Werkstattauslastung wieder auf 95% bringen."
          </p>
          <p data-pf="gray" style={{ color: "#64748B", fontSize: 14, margin: 0 }}>– Geschäftsführer, Autohaus Müller, NRW</p>
        ...
        <div style={{ background: `linear-gradient(135deg, ${DARK}, ${BRAND})`, borderRadius: 16, padding: mob ? "32px 20px" : "44px 32px", textAlign: "center" }}>
          <h2 data-pf="white" style={{ color: "#ffffff", fontSize: mob ? 22 : 28, fontWeight: 700, margin: "0 0 10px" }}>
            Ähnliche Ergebnisse für Ihren Betrieb?
          </h2>
