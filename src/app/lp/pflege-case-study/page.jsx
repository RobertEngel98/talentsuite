...
export default function PflegeCaseStudy() {
  ...
  useEffect(() => {
    ...
    trackMetaViewContent({ contentName: "pflege-case-study", category: "pflege", contentType: "case_study" });
  }, []);

  const handleCalendarClick = () => {
    trackMetaSchedule({ formName: "pflege-casestudy-calendar", category: "pflege", value: 50 });
