export const metadata = {
  ...
  alternates: { canonical: "https://www.talentsuite.io/lp/pflege-case-study" },
  openGraph: {
    ...
    url: "https://www.talentsuite.io/lp/pflege-case-study",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            publisher: { "@type": "Organization", name: "TalentSuite", url: "https://www.talentsuite.io" },
          }),
        }}
      />
      {children}
