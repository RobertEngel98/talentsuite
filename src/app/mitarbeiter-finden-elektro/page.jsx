...
export default function Page() {
  ...
  const submit = async () => {
    ...
    trackLead({ formName: "mitarbeiter-finden-elektro", category: "branchen-landing", industry: "Elektro & Elektrotechnik", value: 50 });
  };
        ...
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div className="bp-cta" data-track-section="cta-form" data-track-section-name="Kontaktformular" style={{ background: "linear-gradient(135deg, #011E2F, #023B5B)", borderRadius: 16, padding: mob ? "32px 18px" : "44px 32px", textAlign: "center" }}>
            ...
            {!showForm && !sent ? (
              ...
              <div data-track-form="mitarbeiter-finden-elektro" style={{ maxWidth: 440, margin: "0 auto", textAlign: "left" }}>
                {[
