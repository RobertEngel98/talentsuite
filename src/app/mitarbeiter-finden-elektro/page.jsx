        ...
        <div style={{ maxWidth: 800, margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: mob ? "1fr 1fr" : "1fr 1fr 1fr 1fr", gap: 12, marginBottom: 32 }}>
            {[
              ...
              { n: "170 Tage", label: "Ø Vakanzzeit", color: "#EF4444" },
          ...
          <div style={{ background: "#ffffff", borderRadius: 16, padding: mob ? "24px 18px" : "32px 28px", marginBottom: 24, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: 8 }}>
              {["Elektroniker (m/w/d)","Elektroinstallateur","Elektrotechniker","Elektromeister","Elektroniker Energie- und Gebäudetechnik"].map((p, idx) => (
          ...
          <div style={{ background: "#ffffff", borderRadius: 16, padding: mob ? "20px 18px" : "28px 28px", marginBottom: 24, boxShadow: "0 4px 20px rgba(0,0,0,0.06)" }}>
            <h2 style={{ color: "#023B5B", fontSize: mob ? 18 : 22, fontWeight: 700, margin: "0 0 12px" }}>
              So gewinnen erfolgreiche Elektrobetriebe heute Fachkräfte
            </h2>
            <p style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.7, margin: "0 0 12px" }}>Der Fachkräftemangel im Elektrohandwerk ist keine vorübergehende Erscheinung — er ist strukturell und wird sich durch die Energiewende weiter verschärfen.</p>
            ...
            <p style={{ color: "#4A5568", fontSize: 15, lineHeight: 1.7, margin: 0 }}>Die Ergebnisse sprechen für sich: 16-24 € pro qualifizierte Bewerbung, 11-15% Conversion-Rate und durchschnittlich 32 Tage bis zur Einstellung.</p>
          </div>
